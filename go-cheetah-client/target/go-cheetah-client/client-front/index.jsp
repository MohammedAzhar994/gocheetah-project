<%-- 
    Document   : index
    Created on : Sep 6, 2022, 2:21:16 PM
    Author     : grays
--%>
<%
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
                        <ul class="navbar-nav  ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="account.jsp?id=<%= id %>"> Account</a>
                            </li>
                            <li class="nav-item">
                                <a style="cursor: pointer" onclick="loadPrice()" class="nav-link" data-toggle="modal"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../client-back/index.jsp">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Book a Taxi</h4>
                </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="orderRegister" class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="orderDesc"
                                               placeholder="Description">
                                    </div>
                                    <div class="form-group">
                                        <label for="orderPrice">Select Package</label>
                                        <select id="orderPrice" class="js-example-basic-single w-100">

                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="orderVehicleType">Select Vehicle Type</label>
                                        <select onchange="loadVehicle()" id="orderVehicleType"
                                    ...
                                    <div class="form-group">
                                        <label for="orderVehicle">Select Vehicle</label>
                                        <select id="orderVehicle" class="js-example-basic-single w-100">
                ...
                <div class="detail-box">
                    ...
                    <div class="text-box">
                        ...
                        <p>
                            ...
                            page when distribution of letters
                        </p>
                    </div>
                    <div class="text-box">
                        <h5>
...
<script type="text/javascript">
    ...
    $("#orderRegister").submit(function (event) {
        var formData = {
            priceId: $("#orderPrice").val(),
            desc: $("#orderDesc").val(),
            vId: $("#orderVehicle").val(),
            date: $("#orderDate").val(),
            customerId: "<%= id %>"
        };
    ...
    function loadVehicle() {
        $.ajax({
            url: "http://localhost:9191/gocheetah-core/vehicle/type",
            dataType: 'json',
            data: {
                type: $('#orderVehicleType').val()
            },
            success: function (data) {
                $('#orderVehicle').html("");
                let val;
                $.each(data, function (key, value) {
                    val += '<option value="' + value.id + '">' + value.name + '- -' + value.brand + '- -' + value.seatCount + '</option>';
                });
                $('#orderVehicle').html(val);
            }
        });
    }
    ...
    function loadPrice() {
        $.ajax({
            ...
            success: function (data) {
                let val;
                $.each(data, function (key, value) {
                    val += '<option value="' + value.id + '">' + value.name + '- -' + value.cost + '</option>';
                });
                $('#orderPrice').html(val);
